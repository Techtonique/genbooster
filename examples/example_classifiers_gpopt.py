...
def genboost_cv(X_train, y_train,
    ...
    try:
        ...
        estimator = BoosterClassifier(n_estimators=int(n_estimators),
        ...
        for train_idx, val_idx in kf.split(X_train):
            ...
            score = estimator.score(X_fold_val, y_fold_val)
            scores.append(score)
        ...
        return -mean_score if mean_score > 0 else -1e6
...
def optimize_genboost(X_train, y_train):
  ...
  gp_opt = gp.GPOpt(objective_func=crossval_objective,
                      ...
                      upper_bound = np.array([2, -0.1,   2, 0.4]),
